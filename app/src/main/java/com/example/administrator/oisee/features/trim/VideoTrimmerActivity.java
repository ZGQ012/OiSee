package com.example.administrator.oisee.features.trim;
...
import com.example.administrator.oisee.databinding.ActivityTrimmerLayoutBinding;
import com.example.administrator.oisee.interfaces.CompressVideoListener;
import com.example.administrator.oisee.interfaces.TrimVideoListener;
import com.example.administrator.oisee.utils.CompressVideoUtil;
    ...
    public void onFinishTrim(String in) {
        ...
        CompressVideoUtil.compress(this, in, out, new CompressVideoListener() {
            ...
            public void onFinish() {
                ...
                Intent intent = new Intent(VideoTrimmerActivity.this, MyprofileActivity.class);
                intent.putExtra("shipin", in);
