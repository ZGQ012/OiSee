...
public class SetqianmingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_setqianming);
        ...
        tv_set_name_complete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(name)) {
                    Toast.makeText(SetqianmingActivity.this, "请输入签名", Toast.LENGTH_SHORT).show();
                    return;
                }
                setName(name);
            }
    ...
    private void setName(final String name) {
        ...
        data.put("personalized_signature", name);
        Gson gson = new Gson();
            ...
            public void onResponse(String response) {
                ...
                try {
                    if (jsonObject.getInt("ErrCode") == 0) {
                        Toast.makeText(SetqianmingActivity.this, "" + jsonObject.getString("ErrMsg"), Toast.LENGTH_SHORT).show();
                        MainActivity.loginBean.getResponse().setPersonalized_signature(name);
                        startActivity(new Intent(SetqianmingActivity.this, MyprofileActivity.class));
                        finish();
                    }
