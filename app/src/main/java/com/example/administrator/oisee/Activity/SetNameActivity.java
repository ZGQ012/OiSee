            ...
            public void onResponse(String response) {
                ...
                try {
                    if (jsonObject.getInt("ErrCode") == 0) {
                        Toast.makeText(SetNameActivity.this, "" + jsonObject.getString("ErrMsg"), Toast.LENGTH_SHORT).show();
                        MainActivity.loginBean.getResponse().setNick_name(name);
                        startActivity(new Intent(SetNameActivity.this, MyprofileActivity.class));
                        finish();
                    }
